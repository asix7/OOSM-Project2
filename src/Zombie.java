...
public class Zombie extends Aggressive_Monster {
    ...
    private final double COOLDOWN = 800;
    private double current_cd = 0;
    private double max_health = 60;
	...
	/** Creates a zombie in the map */
    public Zombie(String image_path, double[] initial_position) 
