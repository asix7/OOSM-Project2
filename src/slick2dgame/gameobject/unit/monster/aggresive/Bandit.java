...
public class Bandit extends Aggressive_Monster {
	...
	/** Creates a bandit in the map */
    public Bandit(String image_path, double[] initial_position) 
